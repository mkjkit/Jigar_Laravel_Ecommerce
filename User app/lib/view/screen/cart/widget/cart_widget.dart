                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(children: [
                      ...
                      Text('${getTranslated('shipping_cost', context)}: ', style: titilliumSemiBold.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL)),
                      Flexible(child: Text('${cartModel.shippingCost}', style: robotoRegular.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL, color: Theme.of(context).disabledColor,))),
                    ]),
                  ):SizedBox()
                ],
              ),
