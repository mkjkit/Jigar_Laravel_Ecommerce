                        ...
                        children: [
                          ListTile(
                            ...
                            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) {
                              ...
                              return ChatScreen(seller: null,shopId: chat.uniqueShopList[index].shopId,name: chat.uniqueShopList[index].sellerInfo.fName+ ' '+ chat.uniqueShopList[index].sellerInfo.lName,image: chat.uniqueShopList[index].sellerInfo.image);
                            })),
                          ),
