                          ...
                          builder: (context, sellerProvider,_) {
                            return Column(crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                ...
                                sellerProvider.sellerModel != null? Row(
                                  children: [
                                    Container(
                                        width: 16,
                                        height: 16,
                                        child: Image.asset(Images.star)),
                                    Text(sellerProvider.sellerModel.avgRating.toString()??'', style: titilliumSemiBold.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE), maxLines: 1, overflow: TextOverflow.ellipsis,),
                                    SizedBox(width: Dimensions.PADDING_SIZE_DEFAULT),
                                    Text(sellerProvider.sellerModel.totalReview.toString() +' '+ '${getTranslated('reviews', context)}', style: titilliumSemiBold.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE), maxLines: 1, overflow: TextOverflow.ellipsis,),
                                  ],
                                ):SizedBox(),
