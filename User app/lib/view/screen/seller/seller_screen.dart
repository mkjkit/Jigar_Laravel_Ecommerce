                ...
                Padding(
                  ...
                  child: ClipRRect(
                    ...
                    child: FadeInImage.assetNetwork(
                      ...
                      image: '${Provider.of<SplashProvider>(context, listen: false).baseUrls.shopImageUrl}/banner/${seller.seller.shop != null ? seller.seller.shop.image : ''}',
                    ...
                    Row(children: [
                      ClipRRect(
                        ...
                        child: FadeInImage.assetNetwork(
                          ...
                          image: '${Provider.of<SplashProvider>(context, listen: false).baseUrls.sellerImageUrl}/${seller.seller.image}',
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text(seller.avgRating.toString()??'', style: titilliumSemiBold.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE), maxLines: 1, overflow: TextOverflow.ellipsis,),
                                SizedBox(width: Dimensions.PADDING_SIZE_DEFAULT),
                                Text(seller.totalReview.toString() + ' ' +'${getTranslated('reviews', context)}', style: titilliumSemiBold.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE), maxLines: 1, overflow: TextOverflow.ellipsis,),
                              ],
                            ),
                          ],
                        ),
