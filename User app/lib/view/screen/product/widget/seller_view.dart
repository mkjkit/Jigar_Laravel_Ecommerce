              ...
              IconButton(
                onPressed: () {
                  if(!Provider.of<AuthProvider>(context, listen: false).isLoggedIn()) {
                    ...
                    Navigator.push(context, MaterialPageRoute(builder: (_) => ChatScreen(seller: seller.sellerModel,shopId: seller.sellerModel.seller.shop.id, name:seller.sellerModel.seller.fName+seller.sellerModel.seller.lName, image: seller.sellerModel.seller.image )));
                  }
                },
