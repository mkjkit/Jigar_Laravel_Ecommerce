                  ...
                  SliverToBoxAdapter(
                    child: Column(
                      children: [
                        ...
                        // Category title
                        Padding(
                          padding: EdgeInsets.fromLTRB(Dimensions.PADDING_SIZE_DEFAULT, Dimensions.PADDING_SIZE_DEFAULT, Dimensions.PADDING_SIZE_DEFAULT, Dimensions.PADDING_SIZE_EXTRA_SMALL  ),
                          child: TitleRow(
                        ...
                        Consumer<FlashDealProvider>(
                          builder: (context, flashDeal, child) {
                            return flashDeal.flashDeal == null
                                ? Padding(padding: EdgeInsets.fromLTRB(Dimensions.PADDING_SIZE_DEFAULT, Dimensions.PADDING_SIZE_DEFAULT, Dimensions.PADDING_SIZE_DEFAULT, Dimensions.PADDING_SIZE_EXTRA_SMALL),
                          ...
                          child: Consumer<ProductProvider>(
                            ...
                            return Row(children: [
                              Expanded(child: Padding(
                                ...
                                child: Text(prodProvider.title == 'xyz' ? getTranslated('new_arrival',context):prodProvider.title, style: titleRegular),
                              )),
